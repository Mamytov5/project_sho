    ...
    return (
        <div className="container mx-auto">
            <div className="flex flex-row mt-9 pb-20">
                ...
                <div className="basis-1/3  text-left ml-10">
                    ...
                    <div className="flex ">
                        Кино: {category.map(el => (
                        <p className="ml-5">{el.id === prodDetail.category ? el.title : ""}</p>))}
                    </div>
                    <div className="flex flex-col w-80">
                        {
                            basketItems ? <button
                                className="bg-blue-900 hover:bg-red-600 text-white font-bold py-2 px-4 rounded my-4">
                        ...
                        <button className="bg-blue-900 hover:bg-red-600 text-white font-bold py-2 px-4 rounded my-4"
